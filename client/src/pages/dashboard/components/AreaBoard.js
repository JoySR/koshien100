...
import {addArea, fetchArea, removeArea, updateArea} from '../../../actions/areaAction'
...
export default class AreaBoard extends Component {
  ...
  onSubmit = () => {
    ...
    const func = isEditing ? updateArea({
        area: {
          id,
          area_id: areaId,
          name: areaName,
  ...
  render() {
    ...
    return (
      <main role="main" className="AreaBoard col-md-9 ml-sm-auto col-lg-10 px-4">
        <h2>Areas</h2>
        <div className="Add-Area">
          ...
          <ul>
            <li>
              <label>Area Id: </label>
              <input value={areaId} onChange={(event) => this.onChange('areaId', event)} />
            </li>
            <li>
              <label>Area Name: </label>
              <input value={areaName} onChange={(event) => this.onChange('areaName', event)} />
            </li>
            <li>
              <label>Area Code: </label>
              <input value={areaCode} onChange={(event) => this.onChange('areaCode', event)} />
            </li>
          </ul>
